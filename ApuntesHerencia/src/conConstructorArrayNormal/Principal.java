...
public class Principal {
    ...
    private static int generarId(Personaje[] personajes, int numPersonajes) {
        ...
        while (repetido) {
            ...
            for (int i = 0; i < numPersonajes; i++) {
                if (personajes[i].getId() == idGenerado) {
                    repetido = true;
                    break;
                }
            }
    ...
    private static int añadirPersonaje(Personaje[] personajes, int numPersonajes) {
        ...
        for (int i = 0; i < cantidad; i++) {
            ...
            int id = generarId(personajes, numPersonajes);
            ...
            if (tipo.equalsIgnoreCase("heroe")) {
                ...
                Heroe h = new Heroe(id, nombre, nivelPoder, bando, organizacion, misiones);
                ...
                Villano v = new Villano(id, nombre, nivelPoder, bando, peligrosidad, arma);
