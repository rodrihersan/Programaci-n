...
public class Personaje {
    ...
    public void pedirDatos(Personaje[] lista, int numPersonajes) {
        ...
        } while (estaRepetido(lista, numPersonajes, idGenerado));
        this.id = idGenerado;
    ...
    private boolean estaRepetido(Personaje[] lista, int numPersonajes, int idGenerado) {
        for (int i = 0; i < numPersonajes; i++) {
            if (lista[i].getId() == idGenerado)
                return true;
        }
        return false;
    }
