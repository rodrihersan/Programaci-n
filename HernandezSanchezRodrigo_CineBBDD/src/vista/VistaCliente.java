...
public class VistaCliente {
    ...
    ClienteDTO actual = clienteControlador.obtenerPorId(id);
    if (actual == null) {
        System.out.println("No se encontro ningun cliente con id " + id);
        return;
    }

    System.out.println("Datos actuales: " + actual.getNombre() + " | " + actual.getEmail() + " | " + actual.getTelefono());
    ...
    if (!validarTelefono(telefono)) {
        System.out.println("Telefono no valido. Operacion cancelada.");
        return;
    }
